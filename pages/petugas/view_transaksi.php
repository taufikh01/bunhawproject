...
<?php
    ...
    while ($array=mysql_fetch_array($query)) {
        echo"<tr>
                ...
                echo"<td><a href='pengembalian.php?id_detail=$array[id_detail]'><font color='red'>Pengembalian</font></a>&nbsp
                    Rincian</td>";
                }else{
                echo"<td><a href='rincian_transaksi.php?id_detail=$array[id_detail]'>Rincian</a></td>
             </tr>";
             }
    }
?>
